...
/**
 * This is the item provider adapter for a {@link fr.steph.foot.matchs.AbstractEnd} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractEndItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractEnd_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractEnd_name_feature", "_UI_AbstractEnd_type"),
				 MatchsPackage.Literals.ABSTRACT_END__NAME,
				 true,
				 false,
				 false,
	...
	protected void addContextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractEnd_context_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractEnd_context_feature", "_UI_AbstractEnd_type"),
				 MatchsPackage.Literals.ABSTRACT_END__CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractEnd_type") :
			getString("_UI_AbstractEnd_type") + " " + label;
	}
