...
/**
 * This is the item provider adapter for a {@link fr.steph.foot.matchs.TimedEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimedEventItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimedEvent_temps_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimedEvent_temps_feature", "_UI_TimedEvent_type"),
				 MatchsPackage.Literals.TIMED_EVENT__TEMPS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TimedEvent)object).getTemps();
